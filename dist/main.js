    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			t109 = space();
    			div27 = element("div");
    			add_location(h50, file, 198, 16, 8112);
    			span0.className = "text-gray-700";
    			add_location(span0, file, 201, 24, 8228);
    			input0.className = "w-auto";
    			attr(input0, "type", "number");
    			input0.min = "100";
    			input0.max = "100000";
    			add_location(input0, file, 203, 24, 8328);
    			add_location(span1, file, 202, 24, 8297);
    			div0.className = "flex";
    			add_location(div0, file, 200, 20, 8185);
    			add_location(label0, file, 199, 16, 8157);
    			span2.className = "text-gray-700";
    			add_location(span2, file, 210, 24, 8610);
    			input1.className = "w-auto";
    			attr(input1, "type", "number");
    			input1.min = "100";
    			input1.max = "100000";
    			add_location(input1, file, 212, 24, 8711);
    			add_location(span3, file, 211, 24, 8680);
    			div1.className = "flex";
    			add_location(div1, file, 209, 20, 8567);
    			add_location(label1, file, 208, 16, 8539);
    			span4.className = "text-gray-700";
    			add_location(span4, file, 219, 24, 8994);
    			input2.className = "w-auto";
    			attr(input2, "type", "number");
    			input2.min = "0";
    			input2.max = "100";
    			add_location(input2, file, 221, 24, 9105);
    			add_location(span5, file, 220, 24, 9074);
    			div2.className = "flex";
    			add_location(div2, file, 218, 20, 8951);
    			add_location(label2, file, 217, 16, 8923);
    			span6.className = "text-gray-700";
    			add_location(span6, file, 228, 24, 9377);
    			input3.className = "w-auto";
    			attr(input3, "type", "number");
    			input3.min = "0";
    			input3.max = "1000000";
    			add_location(input3, file, 230, 24, 9479);
    			add_location(span7, file, 229, 24, 9448);
    			div3.className = "flex";
    			add_location(div3, file, 227, 20, 9334);
    			input4.className = "mt-1 block w-full";
    			attr(input4, "type", "range");
    			input4.min = "0";
    			input4.max = "100000";
    			add_location(input4, file, 234, 20, 9654);
    			add_location(label3, file, 226, 16, 9306);
    			div4.className = "border-2 rounded-lg border-indigo-500 px-5 mb-5";
    			add_location(div4, file, 197, 12, 8034);
    			add_location(h51, file, 238, 16, 9870);
    			span8.className = "text-gray-700";
    			add_location(span8, file, 241, 24, 9987);
    			input5.className = "w-auto";
    			attr(input5, "type", "number");
    			input5.min = "0";
    			input5.max = "24";
    			add_location(input5, file, 243, 24, 10108);
    			add_location(span9, file, 242, 24, 10077);
    			div5.className = "flex";
    			add_location(div5, file, 240, 20, 9944);
    			add_location(label4, file, 239, 16, 9916);
    			span10.className = "text-gray-700";
    			add_location(span10, file, 249, 24, 10358);
    			input6.className = "w-auto";
    			attr(input6, "type", "number");
    			input6.min = "0";
    			input6.max = "100";
    			add_location(input6, file, 251, 24, 10484);
    			add_location(span11, file, 250, 24, 10453);
    			div6.className = "flex";
    			add_location(div6, file, 248, 20, 10315);
    			add_location(label5, file, 247, 16, 10287);
    			span12.className = "text-gray-700";
    			add_location(span12, file, 257, 24, 10744);
    			input7.className = "w-auto";
    			attr(input7, "type", "number");
    			input7.min = "0";
    			input7.max = "1000";
    			add_location(input7, file, 259, 24, 10859);
    			add_location(span13, file, 258, 24, 10828);
    			div7.className = "flex";
    			add_location(div7, file, 256, 20, 10701);
    			input8.className = "mt-1 block w-full";
    			attr(input8, "type", "range");
    			input8.min = "0";
    			input8.max = "1000";
    			add_location(input8, file, 263, 20, 11031);
    			add_location(label6, file, 255, 16, 10673);
    			span14.className = "text-gray-700";
    			add_location(span14, file, 267, 24, 11221);
    			input9.className = "w-auto";
    			attr(input9, "type", "number");
    			input9.min = "0";
    			input9.max = "1000";
    			add_location(input9, file, 269, 24, 11333);
    			add_location(span15, file, 268, 24, 11302);
    			div8.className = "flex";
    			add_location(div8, file, 266, 20, 11178);
    			input10.className = "mt-1 block w-full";
    			attr(input10, "type", "range");
    			input10.min = "0";
    			input10.max = "1000";
    			add_location(input10, file, 273, 20, 11518);
    			add_location(label7, file, 265, 16, 11150);
    			span16.className = "text-gray-700";
    			add_location(span16, file, 277, 24, 11721);
    			input11.className = "w-auto";
    			attr(input11, "type", "number");
    			input11.min = "0";
    			input11.max = "100000";
    			add_location(input11, file, 279, 24, 11826);
    			add_location(span17, file, 278, 24, 11795);
    			div9.className = "flex";
    			add_location(div9, file, 276, 20, 11678);
    			add_location(label8, file, 275, 16, 11650);
    			span18.className = "text-gray-700";
    			add_location(span18, file, 286, 24, 12098);
    			input12.className = "w-auto";
    			attr(input12, "type", "number");
    			input12.min = "0";
    			input12.max = "100";
    			add_location(input12, file, 288, 24, 12199);
    			add_location(span19, file, 287, 24, 12168);
    			div10.className = "flex";
    			add_location(div10, file, 285, 20, 12055);
    			input13.className = "mt-1 block w-full";
    			attr(input13, "type", "range");
    			input13.min = "0";
    			input13.max = "100";
    			add_location(input13, file, 292, 20, 12372);
    			add_location(label9, file, 284, 16, 12027);
    			span20.className = "text-gray-700";
    			add_location(span20, file, 296, 24, 12563);
    			input14.className = "w-auto";
    			attr(input14, "type", "number");
    			input14.min = "0";
    			input14.max = "100";
    			add_location(input14, file, 298, 24, 12663);
    			add_location(span21, file, 297, 24, 12632);
    			div11.className = "flex";
    			add_location(div11, file, 295, 20, 12520);
    			input15.className = "mt-1 block w-full";
    			attr(input15, "type", "range");
    			input15.min = "0";
    			input15.max = "100";
    			add_location(input15, file, 302, 20, 12835);
    			add_location(label10, file, 294, 16, 12492);
    			span22.className = "text-gray-700";
    			add_location(span22, file, 306, 24, 13025);
    			input16.className = "w-auto";
    			attr(input16, "type", "number");
    			input16.min = "0";
    			input16.max = "100";
    			add_location(input16, file, 308, 24, 13149);
    			add_location(span23, file, 307, 24, 13118);
    			div12.className = "flex";
    			add_location(div12, file, 305, 20, 12982);
    			add_location(label11, file, 304, 16, 12954);
    			div13.className = "border-2 rounded-lg border-green-500 px-5 mb-5";
    			add_location(div13, file, 237, 12, 9793);
    			add_location(h52, file, 315, 16, 13446);
    			span24.className = "text-gray-700";
    			add_location(span24, file, 318, 24, 13566);
    			input17.className = "w-auto";
    			attr(input17, "type", "number");
    			input17.min = "0";
    			input17.max = "100";
    			add_location(input17, file, 320, 24, 13670);
    			add_location(span25, file, 319, 24, 13639);
    			div14.className = "flex";
    			add_location(div14, file, 317, 20, 13523);
    			input18.className = "mt-1 block w-full";
    			attr(input18, "type", "range");
    			input18.min = "0";
    			input18.max = "100";
    			add_location(input18, file, 324, 20, 13843);
    			label12.className = "block";
    			add_location(label12, file, 316, 16, 13481);
    			span26.className = "text-gray-700";
    			add_location(span26, file, 328, 24, 14056);
    			div15.className = "flex mb-5";
    			add_location(div15, file, 327, 20, 14008);
    			input19.className = "w-auto";
    			attr(input19, "type", "number");
    			input19.min = "0";
    			input19.max = "100";
    			add_location(input19, file, 331, 24, 14204);
    			option0.__value = "arpa";
    			option0.value = option0.__value;
    			add_location(option0, file, 335, 32, 14457);
    			option1.__value = "arpa - cost_per_customer";
    			option1.value = option1.__value;
    			add_location(option1, file, 338, 32, 14607);
    			if (ctx.valuation_metric === void 0) add_render_callback(() => ctx.select_change_handler.call(select));
    			add_location(select, file, 334, 28, 14386);
    			attr(path, "d", "M9.293 12.95l.707.707L15.657 8l-1.414-1.414L10 10.828 5.757 6.586 4.343 8z");
    			add_location(path, file, 343, 121, 15029);
    			attr(svg, "class", "fill-current h-4 w-4");
    			attr(svg, "xmlns", "http://www.w3.org/2000/svg");
    			attr(svg, "viewBox", "0 0 20 20");
    			add_location(svg, file, 343, 32, 14940);
    			div16.className = "pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700";
    			add_location(div16, file, 342, 28, 14810);
    			div17.className = "relative";
    			add_location(div17, file, 333, 24, 14335);
    			div18.className = "flex";
    			add_location(div18, file, 330, 20, 14161);
    			add_location(span27, file, 348, 24, 15290);
    			div19.className = "text-center mt-4";
    			add_location(div19, file, 347, 20, 15235);
    			label13.className = "block";
    			add_location(label13, file, 326, 16, 13966);
    			div20.className = "border-2 rounded-lg border-red-500 px-5 mb-5";
    			add_location(div20, file, 314, 12, 13371);
    			div21.className = "col-span-12 md:col-span-4";
    			add_location(div21, file, 196, 8, 7982);
    			add_location(h53, file, 355, 16, 15568);
    			canvas_1.width = "400";
    			canvas_1.height = "200";
    			add_location(canvas_1, file, 356, 16, 15606);
    			span28.className = "font-bold";
    			add_location(span28, file, 358, 38, 15790);
    			span29.className = "text-red-500";
    			add_location(span29, file, 358, 97, 15849);
    			span30.className = "text-indigo-500";
    			add_location(span30, file, 360, 117, 16056);
    			span31.className = "text-green-500";
    			add_location(span31, file, 360, 179, 16118);
    			add_location(li0, file, 360, 24, 15963);
    			span32.className = "text-indigo-500";
    			add_location(span32, file, 361, 129, 16300);
    			add_location(li1, file, 361, 24, 16195);
    			span33.className = "text-green-500";
    			add_location(span33, file, 362, 101, 16476);
    			add_location(li2, file, 362, 24, 16399);
    			span34.className = "text-green-500";
    			add_location(span34, file, 363, 145, 16673);
    			add_location(li3, file, 363, 24, 16552);
    			span35.className = "text-indigo-500";
    			add_location(span35, file, 364, 137, 16858);
    			add_location(li4, file, 364, 24, 16745);
    			span36.className = "text-indigo-500";
    			add_location(span36, file, 365, 131, 17039);
    			add_location(li5, file, 365, 24, 16932);
    			ul.className = "list-disc pl-5";
    			add_location(ul, file, 359, 20, 15911);
    			div22.className = "border-t-2 border-gray-500 mt-5 text-left p-8 text-xl";
    			add_location(div22, file, 357, 16, 15684);
    			div23.className = "border-2 rounded-lg border-yellow-500 px-5 sticky top-10";
    			add_location(div23, file, 354, 12, 15481);
    			div24.className = "col-span-12 md:col-span-8";
    			add_location(div24, file, 353, 8, 15429);
    			div25.className = "grid grid-cols-12 gap-4";
    			add_location(div25, file, 195, 4, 7936);
    			div26.className = "min-h-64 grid grid-rows-1 grid-flow-col gap-4";
    			add_location(div26, file, 371, 4, 17207);
    			div27.className = "min-h-64 grid grid-rows-1 grid-flow-col gap-4 mt-5";
    			add_location(div27, file, 374, 4, 17283);
    			add_location(main, file, 194, 0, 7925);
    ...
    function instance($$self, $$props, $$invalidate) {
        ...
        function renderChart(
            ...
            if (canvas) {
                ...
                $$invalidate('chart', chart = new Chart(ctx, {
                    type: 'line',
                    data: data,
                    options: {
                        animation: false,
